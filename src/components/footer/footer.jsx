    ...
    <footer className="footer">
      <div className="container">
        <div className="main-footer">
          <a href="#" className="main-footer__facebook-icon">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          <a href="#" className="main-footer__instagram-icon">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
          ...
          <a href="#" className="main-footer__twitter-icon">
            <svg
              width="37"
              height="30"
              viewBox="0 0 37 30"
          ...
          <a href="#" className="main-footer__linkedin-icon">
            <svg
              width="30"
              height="30"
              viewBox="0 0 30 30"
